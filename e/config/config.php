...
$ecms_config['db']['dbpassword']='zhuzhu';	//数据库密码
$ecms_config['db']['dbname']='mis_ecms';	//数据库名
$ecms_config['db']['setchar']='utf8';	//设置默认编码
$ecms_config['db']['dbchar']='utf8';	//数据库默认编码
$ecms_config['db']['dbtbpre']='kenmis_';	//数据表前缀
...
//后台安全设置
$ecms_config['esafe']['loginauth']='zhuzhuhawk';	//登录认证码,如果设置登录需要输入此认证码才能通过
$ecms_config['esafe']['ecookiernd']='TpPgeKNKUq46Saw3P0enFJkNBsKhUb';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='unjjn';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='etpjm';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='NiK1jokeMf3F2F8GSJXmhWQOs0d3LX';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='6gXKmClkpcTxEg6vRFj4DtONfPr9rp';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
'fpath'=>0,
'filepath'=>'Y-m-d',
'nreclass'=>',2,8,34,35,36,37,55,',
'nreinfo'=>',2,8,34,35,36,37,55,',
'nrejs'=>',2,34,35,36,37,',
'nottobq'=>',',
'defspacestyleid'=>1,
'canposturl'=>'',
...
'keytog'=>0,
'keytime'=>10,
'keyrnd'=>'1Gkwr0S2LRnqHR4wRgCXpv1wkAq3AI',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/e/action/ListInfo/?classid=2\">新闻中心</a>&nbsp;|&nbsp;<a href=\"/download/\">下载中心</a>&nbsp;|&nbsp;<a href=\"/movie/\">影视频道</a>&nbsp;|&nbsp;<a href=\"/shop/\">网上商城</a>&nbsp;|&nbsp;<a href=\"/flash/\">FLASH频道</a>&nbsp;|&nbsp;<a href=\"/photo/\">图片频道</a>&nbsp;|&nbsp;<a href=\"/e/action/ListInfo/?classid=8\">文章中心</a>&nbsp;|&nbsp;<a href=\"/info/\">分类信息</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
